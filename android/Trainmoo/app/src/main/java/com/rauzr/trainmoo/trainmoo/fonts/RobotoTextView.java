package com.rauzr.trainmoo.trainmoo.fonts;
...
public class RobotoTextView extends TextView {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        Log.i("typeface: " , typeface + "");
        Log.i("getRoboto(typeface)", getRoboto(typeface).toString());
    ...
    public static Typeface getRoboto(Context context, int typeface) {
        switch (typeface) {
            ...
            case Roboto.ROBOTO_REGULAR:
                Log.i("Loading ROBOTO_REGULAR " , "" + Roboto.sRobotoRegular);
