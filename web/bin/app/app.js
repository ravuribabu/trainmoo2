...
angular.module("blog/blogCard.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("blog/blogCard.tpl.html",
    "<div class=\"box\" style=\"margin-top: 10px;padding:5px;height: auto;\">\n" +
    "	 <div class=\"media\">\n" +
...
angular.module("blog/blogCard.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("blog/blogCard.tpl.html",
    "<div class=\"box\" style=\"margin-top: 10px;padding:5px;height: auto;cursor: pointer;\">\n" +
    "	 <div class=\"media\">\n" +
    "		<div class=\"media-left\" ng-if=\"draft.previewImg\">\n" +
    "		    <img class=\"media-object\" ng-src=\"{{draft.previewImg}}\" alt=\"...\">\n" +
    "		</div>\n" +
...
angular.module("blog/blogCard.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("blog/blogCard.tpl.html",
    ...
    "</style>\n" +
    " \n" +
    "<div class=\"card\" style=\"margin-top: 10px;padding:5px;height: auto;cursor: pointer;\">\n" +
    "	 <div class=\"media\">\n" +
    "		<div class=\"media-left\" ng-if=\"draft.previewImg\">\n" +
    "		    <img class=\"media-object\" ng-src=\"{{draft.previewImg}}\" alt=\"...\">\n" +
    "		</div>\n" +
