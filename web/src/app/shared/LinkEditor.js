    ...
    render() {
        ...
        if (this.state.showURLInput) {
            urlInput = <div style={styles.urlInputContainer}>
                <input onChange={this.onURLChange} ref="url" style={styles.urlInput} type="text" value={this.state.urlValue} onKeyDown={this.onLinkInputKeyDown}/>
...
const Link = (props) => {
    ...
    return (
        <a href={url} style={styles.link}> Good God
            {props.children}
        </a>
    );
};
